...
class IntenseLeanBodyRoute extends StatelessWidget{
  @override
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
          ...
          title:new Text("LEAN BODY - INTENSE MODE")
      ),
      body: new Stack(
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Straight Bar Bench Press,Dumbbell Bench Press,Bent Forward Cable crossover -12,12,10,10 (each) ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: ' SHOULDERS: ', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.redAccent,fontSize: 15)),
                    TextSpan(text: 'Seated Dumbbell Overhead Press - 4 x 12 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Lateral Head with V Bar-12,12,10 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Squads, Leg Press, Walking Lunge, Single Leg Curl(back), Glute Hamstrings Raise-12,12,10,10(each) ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Repeat Shoulder and Arms exercises plus Seated Dumbbell Lateral Raise (4x12) - Thursday only,Increase cardio to 45 minutes & Pliability for the whole body to 30 minutes (both days) ', style: TextStyle(fontSize:15,color:Colors.white)),
