...
void main() {
  runApp(new MaterialApp(
    home: new IntenseMuscleGainRoute(),
  ));
}
                  ...
                  child: const Text.rich(
                    TextSpan(
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(text: ' Finish Workout with exercise for ABS (minimum 100 reps) & Pliability for current muscle groups used for 10-15 min.', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.black,fontSize: 18)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: 'Pull Ups, Lat Pulldowns, Bent-Over Barbell Rows, Seated Cable Rows - 12, 10, 8, 6, 4, 2 (each) ', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: 'Behind Head Push Press, Seated Dumbbell Overhead Press- 12, 10, 8, 6 ', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: 'Curls, Cable Rope Hammer Curl- 12, 12, 10, 8, 6 (each)', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: 'Straight Bar Bench Press, Dumbbell Bench Press, Bent Forward Cable crossover - 12, 10, 8, 6, 4, 2 (each)   ', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: ' SHOULDERS: ', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.redAccent,fontSize: 26)),
                          TextSpan(text: 'Seated Dumbbell Overhead Press - 15, 12, 12, 10, 6 ', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: 'Lying Triceps Extensions, Lateral Head with V Bar - 12, 12, 10, 8', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: 'Squads, Leg Press, Walking Lunge, Single Leg Curl(back), Glute Hamstrings Raise-12, 10, 8, 6, 4 , 2  (each) ', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: ' SHOULDERS: ', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.redAccent,fontSize: 26)),
                          TextSpan(text: 'Seated Dumbbell Lateral Raise, Behind Head Push Press, Seated Dumbbell Overhead Press, Cable Cross-over Reverse Fly - 12, 12, 10, 8, 6 (each)', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: 'Lying Triceps Extensions, Triceps Dips, Lateral Head with V Bar, One-Arm Overhead Extensions - 12, 10, 10, 8, 6 (each)', style: TextStyle(fontSize:24,color:Colors.white)),
                    ...
                    const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(text: ' BICEPS: ', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.redAccent,fontSize: 26)),
                          TextSpan(text: 'Standing Barbell Curls, Curls, Cable Rope Hammer Curl- 12, 12, 10, 8, 6 (each)', style: TextStyle(fontSize:24,color:Colors.white)),
