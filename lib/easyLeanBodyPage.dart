...
class EasyLeanBodyRoute extends StatelessWidget{
  @override
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
          ...
          title:new Text("LEAN BODY - EASY MODE")
      ),
      body: new Stack(
                ...
                child: const Text.rich(
                  TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(text: '15 Minutes of Pliability exercises for the whole body, followed with 30 minutes of cardio - preferebly on stepper machine or treadmill.', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Lat Pulldowns - 4 series x 15,12,10,8 reps ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Dumbbell Bench Press - 4 x 15,12,10,8 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Seated Dumbbell Overhead Press - 4 x 15,12,10,8 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: ' SHOULDERS: ', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.redAccent,fontSize: 17)),
                    TextSpan(text: 'Seated Dumbbell Lateral Raise - 4 x 15,15,12,12 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: ' SHOULDERS: ', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.redAccent,fontSize: 17)),
                    TextSpan(text: 'Cable Cross-over Reverse Fly- 4 x 15,15,12,12 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Squads- 4 x 15,12,10,8 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Curls- 3 x 15,12,12 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Lateral Head with V Bar- 4 x 15,12,12,10 ', style: TextStyle(fontSize:16,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Increase cardio to 45 minutes & Pliability for the whole body to 30 minutes ', style: TextStyle(fontSize:16,color:Colors.white)),
