  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
          ...
          title: new Text( "MEDIUM LEAN BODY WORKOUT",style: TextStyle(color: Colors.white,fontSize: 20,fontStyle: FontStyle.italic) )
      ),
      body: new Stack(
        fit: StackFit.expand,
        children: <Widget>[
                  ...
                  child: const Text.rich(
                    TextSpan(
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(text: ' Finish Workout with exercise for ABS (minimum 75 reps).', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.grey,fontSize: 20)),
                      ],
                    ),
                  ),
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text("Barbell bench press (4 sets, 12, 10, 10, 7 pyramid reps)" ,style: TextStyle(color: Colors.white,fontSize: 24)),
                    Text("Incline dumbbell press (2-3 sets, 10-15 reps)" ,style: TextStyle(color: Colors.white,fontSize: 24)),
                    Text("Smith machine bench press (2 sets, 10-15 reps)" ,style: TextStyle(color: Colors.white,fontSize: 24)),
                    Text("Supine dumbbell flyes (2-3 sets, 10-15 reps)" ,style: TextStyle(color: Colors.white,fontSize: 24)),
                    Text("Flat bench cable flyes (2 sets, 10-15 reps)" ,style: TextStyle(color: Colors.white,fontSize: 24)),
                    Text("Butterflies (2 sets, 10-15 reps)" ,style: TextStyle(color: Colors.white,fontSize: 24)),
                    Padding(padding: EdgeInsets.all(10.0)),
                    Row(
