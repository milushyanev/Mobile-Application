...
class _MediumWeightLossRoute extends State<MediumWeightLossRoute> {
  ...
  var listDay=['BACK SHOULDERS BICEPS',
    ...
    'SHOULDERS',
    'TRICEPS AND BICEPS'];
  var listDayEx=['Lat Pulldowns,Bent-Over Barbell Rows,Seated Cable Rows - 4x12 (each). Cable Cross-over Reverse Fly- 12, 10, 8 . Curls- 12, 12, 10, 8.',
    ...
    'Lying Triceps Extensions, Triceps Dips, Lateral Head with V Bar, One-Arm Overhead Extensions - 12, 12, 10, 8 (each). Standing Barbell Curls, Curls, Cable Rope Hammer Curl- 12, 12, 10 (each).'
  ];
