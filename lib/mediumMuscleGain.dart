...
class MediumMuscleGainRoute extends StatelessWidget{
  @override
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
          ...
          title:new Text("MUSCLE GAIN - MEDIUM MODE")
      ),
      body: new Stack(
                ...
                child: const Text.rich(
                  TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(text: ' Finish Workout with exercise for ABS (minimum 75 reps) & Pliability for current muscle groups used for 10-15 min.', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.redAccent,fontSize: 14)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Pull Ups, Lat Pulldowns, Bent-Over Barbell Rows, Seated Cable Rows -12,10,8,6,4 (each) ', style: TextStyle(fontSize:14,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Behind Head Push Press, Seated Dumbbell Overhead Press,- 12,10,8 ', style: TextStyle(fontSize:14,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Curls, Cable Rope Hammer Curl- 12,12,10,8 (each)', style: TextStyle(fontSize:14,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Straight Bar Bench Press,Dumbbell Bench Press,Bent Forward Cable crossover -12,10,8,6,4 (each) ', style: TextStyle(fontSize:14,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Lying Triceps Extensions, Lateral Head with V Bar-12,12,10 ', style: TextStyle(fontSize:14,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Squads, Leg Press, Walking Lunge, Single Leg Curl(back), Glute Hamstrings Raise-12,10,8,6,4(each) ', style: TextStyle(fontSize:14,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: ' BICEPS: ', style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold,color:Colors.redAccent,fontSize: 14)),
                    TextSpan(text: 'Standing Barbell Curls, Curls, Cable Rope Hammer Curl- 12,12,10,8 (each)', style: TextStyle(fontSize:14,color:Colors.white)),
              ...
              const Text.rich(
                TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: 'Lying Triceps Extensions, Triceps Dips, Lateral Head with V Bar, One-Arm Overhead Extensions - 12,10,10,8 (each)', style: TextStyle(fontSize:14,color:Colors.white)),
