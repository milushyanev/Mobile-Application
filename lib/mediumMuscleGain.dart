...
class _MediumMuscleGainRoute extends State<MediumMuscleGainRoute> {
  ...
  var listDay=['BACK SHOULDERS BICEPS',
    ...
    'SHOULDERS',
    'TRICEPS BICEPS'];
  var listDayEx=['Lateral Pulldowns, Bent-Over Barbell Rows,Seated Cable Rows - 12, 10, 8, 6, 4 (each). Behind Head Push Press, Seated Dumbbell Overhead Press,- 12, 10, 8.  Curls, Cable Rope Hammer Curl - 12, 12, 10, 8 (each) ',
    'Straight Bar Bench Press, Dumbbell Bench Press, Bent Forward Cable crossover - 12, 10, 8, 6, 4 (each). Seated Dumbbell Overhead Press - 15, 12, 12, 10. Lying Triceps Extensions, Lateral Head with V Bar - 12, 12, 10.',
    'Squads, Leg Press, Walking Lunge, Single Leg Curl(back), Glute Hamstrings Raise - 12, 10, 8, 6, 4(each). Shrugs, Upright Rows - 12, 10 , 8, 6 (each).',
    ...
    'Lying Triceps Extensions, Triceps Dips, Lateral Head with V Bar, One-Arm Overhead Extensions -  12, 10, 10, 8 (each). '
        'Standing Barbell Curls, Curls, Cable Rope Hammer Curl- 12, 12, 10, 8 (each).'];
                        ...
                        children: <Widget>[
                          Container(
                            child: const ListTile(
                              ...
                              title: Text("MEDIUM MUSCLE GAIN WORKOUT"),
